        ...
        <div class="p-6 space-y-6">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                <div>
                    ...
                    <p class="text-sm text-gray-500 dark:text-gray-400 mt-0.5">Kelola akun pengguna di daerah Anda.</p>
                </div>
                <button @click="bukaModalTambah"
                    class="inline-flex items-center gap-1.5 text-sm font-semibold text-white px-4 py-2 rounded-xl transition-all shadow-sm shrink-0"
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-sm ljn-table">
                        ...
                        <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                            <tr v-for="u in users" :key="u.id" class="transition-colors duration-100">
                                ...
                                <td class="px-5 py-3.5">
                                    <span class="bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-400 px-2.5 py-1 rounded-full text-xs font-medium">
                                        {{ u.role }}
                                    </span>
                                </td>
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-full max-w-sm">
                        <div class="px-6 py-5 border-b border-gray-100 dark:border-gray-700 flex items-center justify-between">
                            <h2 class="font-bold text-gray-800 dark:text-gray-100">
                                {{ modalMode === 'tambah' ? 'Tambah User' : 'Edit User' }}
                            </h2>
                        ...
                        <div class="px-6 py-5 space-y-4">
                            ...
                            <div v-if="modalMode === 'tambah'">
                                <label class="block text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wider mb-1.5">Role</label>
                        ...
                        <div class="px-6 pb-5 flex gap-3">
                            ...
                            <button @click="simpan" :disabled="loading"
                                class="flex-1 text-white py-2.5 rounded-xl text-sm font-semibold disabled:opacity-50 transition-colors"
                                style="background:#1e4db7;">
